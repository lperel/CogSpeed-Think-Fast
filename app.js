...
RESULTS METRIC EXPLANATIONS
 ...
 Disposition = operational recommendation aligned to the seven-point Samn-Perelli Fatigue Scale (SP-FS). For Mode 2 the CPA score drives the disposition; for Modes 1, 3, and 4 the CPI score is used (same 0–100 scale, same band edges). Speedometer disposition window bands are grouped as follows: GREEN — Clear for duty: ≥ 90 = SP-FS 7, Functioning exceptionally well; 77.5 to <90 = SP-FS 6, Functioning very well; 62.5 to <77.5 = SP-FS 5, Functioning normally. YELLOW — Monitor / human review recommended: 37.5 to <62.5 = SP-FS 4, Functioning slightly less than normal. ORANGE — Human review required: 18 to <37.5 = SP-FS 3, Functioning starting to slow. RED — Remove from Hazardous Duty: 5.5 to <18 = SP-FS 2, Difficult to function / becoming unsafe; <5.5 = SP-FS 1, Unable to function / definitely unsafe. CogSpeed disposition is a structured recommendation requiring human review — not a standalone fitness determination.`;
}
